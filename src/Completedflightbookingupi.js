...
const CompleteFlightbookinguapi = () => {
  ...
  const [selectedPassengerKey, setSelectedPassengerKey] = useState(PassengerInfo?.[0]?.Key);
  ...
  const finalfetch = async () => {
    ...
    try {
      ...
      if (Data.status) {
        ...
        setSegments(Array.isArray(segmentsData) ? segmentsData : [segmentsData]);
                      ...
                      <div className="booking-left">
                        <div>
                          <div className="baggagae_policy mb-3">
                            <>
                              <span className='Bookingsuccessful' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                {taxivaxiresponse?.response?.message || taxivaxiresponse?.error}
                                {/* <span>
                              ...
                              >
                                ...
                                <div className="flex justify-between items-center px-4 py-2 bg-gray-50">
                                  <div className="text-lg font-semibold text-[#0E0E3E]">
                                    {data?.from_city} <span className="mx-2">→</span> {data?.to_city}
                                  </div>
                                  <span className="block text-sm text-gray-500">
                                    {handleweekdatemonthyear(data?.departure_datetime)}
                                  </span>
                                ...
                                <div className="flex items-center justify-between px-4 py-3 gap-6">
                                  <div className="flex items-center gap-2 max-w-[120px]">
                                    ...
                                    />
                                    <div>
                                      <div className="font-medium text-gray-800">{data?.flight}</div>
                                      <div className="text-xs text-gray-500">{data?.flight_no}</div>
                                    </div>
                                  </div>
                                  <div className="text-center max-w-[180px]">
                                    ...
                                    <div className="text-xs text-gray-500">{data?.from_city}</div>
                                  </div>
                                  ...
                                  <div className="text-center max-w-[180px]">
                                    ...
                                    <div className="text-xs text-gray-500">{data?.to_city}</div>
                                  </div>
                                </div>

                                {/* Passenger Details */}
                                <div className="px-4 py-3 border-t bg-gray-50">
                                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Passenger Details</h4>

                                  {data?.Passengers?.map((passenger, pIndex) => (
                                    <div
                                      key={pIndex}
                                    ...
                                    >
                                      <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-xs text-gray-500">Age: {passenger.Age || 'NA'}</span>
                                      </div>

                                      {/* Optional Services */}
                                      {passenger?.OptionalServices?.length > 0 && (
                                        <div className="mt-2">
                                          <p className="text-xs font-semibold text-gray-600 mb-1">
                                            Selected Services:
                                          </p>
                                          <ul className="list-disc list-inside text-xs text-gray-700 space-y-1">
                                            {passenger.OptionalServices.map((service, sIndex) => (
                                              <li key={sIndex}>
                                                {service.Type === "PreReservedSeatAssignment" ? (
                                                  <>
                                                    Seat:{" "}
                                                    <span className="font-medium">
                                                  ...
                                                  <>
                                                    {service.Value} (₹{service.TotalPrice})
                                                  </>
                                                )}
                                              </li>
                                            ))}
              ...
              <div className="bsp-page-r ">
                <div className="checkout-coll mr-2">
                  <div className="chk-details">
                    <span className='Bookingsuccessful' >Booking Id : {taxivaxiresponse?.response?.booking_id || "NA"}</span>
                    ...
                    <div className="chk-detais-row">
                      ...
                      <div className="chk-line">
                        ...
                        <span className="chk-r">{FlightDetails?.seat_type}</span>
                        <div className="clear" />
                      </div>
                      ...
                      <div className="chk-line">
                        ...
                        <span className="chk-r">
                          ₹ {FlightDetails?.fareDetails?.total_ex_tax_fees?.toFixed(2)}
                        </span>
                        <div className="clear" />
                      </div>
                      <div className="chk-line">
                        ...
                        <span className="chk-r">
                          ₹ {FlightDetails?.fareDetails?.tax_and_fees?.toFixed(2)}
                        </span>
                        <div className="clear" />
                      </div>
                    </div>
